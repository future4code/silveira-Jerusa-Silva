...
export const ApplicationFormPage = () => {
  ...
  const applyToTrip = () => {
    ...
    axios
      .post(`https://us-central1-labenu-apis.cloudfunctions.net/labeX/jerusa-silva-silveira/trips${form.idViagem}/apply`, body)
      .then((response) => {        
  ...
  useEffect(() => {
    ...
    axios
      .get(
        "https://us-central1-labenu-apis.cloudfunctions.net/labeX/jerusa-silva-silveira/trips"
