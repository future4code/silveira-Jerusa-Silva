...
export const TripDetailsPage = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://us-central1-labenu-apis.cloudfunctions.net/labeX/jerusa-silva-silveira/trip/${id}`,
        {
          headers: {
            auth: token
          }
  ...
  const putDecideCandidate = (candidateId, aprovado) => {
    ...
    axios
      .put(
        `https://us-central1-labenu-apis.cloudfunctions.net/labeX/jerusa-silva-silveira/trips/${trip.id}/candidates/${candidateId}/decide`,
        body,
        {
          headers: {
            auth: token
